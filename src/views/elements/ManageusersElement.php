        ...
        <?php
            ...
            foreach ($data['USERS'] as $user) { ?>
                ...
                foreach ($out_columns as $colname) {
                    ...
                    $td_style = ($data['FORM_TYPE'] == 'edituser' &&
                ...
                if ($user['USER_ID'] == C\PUBLIC_USER_ID) {
                    ...
                    <a href="<?= $base_url; ?>"><b><?=
                    tl('manageusers_element_edit') ?></b></a></td><?php
                } ?>
                <td <?=$td_style?> ><?php
                    if (in_array($user['USER_ID'], $default_accounts)) {
                        e('<span class="gray">'.
                ...
                if ($data['FORM_TYPE'] == 'edituser' &&
                    $data['CURRENT_USER']['user_name'] == $user['USER_NAME']) {
