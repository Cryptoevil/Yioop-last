...
class ResultsEditorElement extends Element
{
    ...
    public function render($data)
    {
        ...
        <li><a href="javascript:switchTab('editresulttab', 'knowledgetab');"
            id='editresulttabitem'
            class="<?=$data['edit_result_active'] ?>"><?=
            tl('resultseditor_element_edit_results')?></a></li>
        <li><a href="javascript:switchTab('knowledgetab', 'editresulttab');"
            id='knowledgetabitem'
            class="<?=$data['knowledge_wiki_active'] ?>"><?=
            tl('resultseditor_element_knowledge_wiki')?></a></li>
        </ul>
        ...
        if ($edit_url_mode) { ?>
            ...
            <div class="center slight-pad"><button class="button-box"
                ...
                type="submit" name='arg' value='saveresult'><?=
