    ...
    public function renderRoleTable($data)
    {
        ...
        <table class="admin-table">
            ...
            foreach ($data['ROLES'] as $role) {?>
                <tr><?php
                $td_style = ($data['FORM_TYPE'] == 'editrole' &&
                ...
                if ($data['CURRENT_ROLE']['name'] != $role['NAME']) {
                    ...
                    <a href="<?= $base_url; ?>"><b><?=
                    tl('manageroles_element_edit') ?></b></a></td><?php
                }
                ?>
                <td <?=$td_style?> ><?php
                ...
                if ($data['FORM_TYPE'] == 'editrole' &&
                    $data['CURRENT_ROLE']['name'] == $role['NAME']) {
                    ?><tr><td colspan='3'
