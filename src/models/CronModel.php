...
class CronModel extends Model
{
     ...
     *
     * @param string $key field to update time for
     * @param int $time unix time to set the time associated to key to,
     ...
     */
    public function updateCronTime($key, $time = false, $transaction = false)
    {
        if ($this->cron_table === null) {
            $this->loadCronTable();
        }
