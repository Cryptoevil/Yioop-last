...
class SourceModel extends ParallelModel
{
    ...
    /**
     * Returns the medica categories of the search sources that have been
     * stored
     *
     * @return array of distinct media categories for non feed_podcast search
     *  sources
     */
    public function getMediaCategories($exclude_categories = [])
    {
        $sql = "SELECT DISTINCT CATEGORY FROM MEDIA_SOURCE WHERE ".
            "NOT TYPE='feed_podcast'";
        $db = $this->db;
