...
class Trie
{
     ...
     * @param string $term the term to be inserted
     @ @param bool $raw_url_decode decide term should be encoded in utf-8 or url
     * @return array $trie_array beneath last letter of term inserted
     */
    public function add($term,$raw_url_decode=true)
    {
        ...
        for ($i = 0; $i < mb_strlen($term_arr[0],"utf-8"); $i++) {
            ...
            $enc_char = $raw_url_decode? rawurlencode($character) : $character;
