...
; NOINDEX which says the document should not show up in the index at search
; time. With NOPROCESS info about page can show up in the index, if there was
...
EOD;
    ...
    public function pageSummaryProcessing(&$summary, $url)
    {
        ...
        $title_description = $summary[self::TITLE] . " ".
    ...
    {
        $test_string = mb_strtolower($test_string);
