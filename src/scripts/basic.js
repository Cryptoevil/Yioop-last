...
{
    toggleDisplay('more-options-background');
    let body_tag_obj = tag('body')[0];
    let more_obj = elt('more-options');
    ...
    if (more_obj.style.left == '0px' || more_obj.style.right == '0px') {
        if (body_tag_obj.classList.contains('html-ltr')) {
            body_obj.style.marginLeft = '0px';
            more_obj.style.left = '-300px';
